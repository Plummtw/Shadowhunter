...
import org.plummtw.shadowhunter.view._
...
class Boot {
  ...
  def boot {
    ...
    // Snippet
    LiftRules.addToPackages("org.plummtw.shadowhunter")
    ...
    val schimifier_results = Schemifier.schemify(true, Schemifier.infoF _,
      ...
      Action, AdminManage, CardPool, Room, RoomRound, RoomPhase, Talk,
      User, UserEntry, UserIcon, UserLogin)
